    ...
    <header id="top-header" class="l-header">
      <div class="l-header__inner">
        <div class="mobile__menu">
          <p class="l-header__logo"> <a href="<?php echo esc_url(home_url()); ?>" class="header__logoLink">スマートレストランプロジェクト
            </a></p>
        ...
        <nav class="l-header__nav">
          <ul class="l-header__nav-list">
            <li class="l-header__nav-item"><a href="<?php echo esc_url(home_url()); ?>"><i class="fas fa-home"></i> </a></a></li>
            <li class="l-header__nav-item"><a href="<?php echo esc_url(home_url('shops')); ?>">店舗一覧</a></li>
            <li class="l-header__nav-item"><a href="<?php echo esc_url(home_url('contact')); ?>">お問い合わせ</a></li>
